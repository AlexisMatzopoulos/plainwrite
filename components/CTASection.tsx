    ...
    >
      <div className="lg:container mx-auto px-4 text-center">
        ...
        <p className="text-slate-600 max-w-2xl mx-auto mb-8">
          Turn robotic, AI-generated content into clear, natural writing that passes every AI
          detector. With NaturalWrite, you can humanize your text in seconds — no editing skills
          required.
        </p>
        <Link
