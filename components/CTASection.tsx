    ...
    >
      <div className="lg:container mx-auto px-4 text-center">
        ...
        <Link
          ...
          className="inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium transition-colors h-12 px-8 bg-rose-400 hover:bg-rose-500 text-white text-lg rounded-[14px]"
        >
          Kostenlos starten
        </Link>
